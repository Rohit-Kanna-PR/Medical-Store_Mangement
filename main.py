...
def open_win():
    ...
    apt = Tk()
    apt.title("Interface")
    Label(apt, text="RRRR MEDICAL STORE COMPANY").grid(row=0, column=0, columnspan=3)
...
def again():
    ...
    Label(root, text='RRRR MEDICAL STORE COMPANY').grid(row=0, column=0, columnspan=5)
...
def open_cus():
    ...
    apt = Tk()
    apt.title("Interface")
    Label(apt, text="*** RRRR MEDICAL DRUG STORE ***", bg='blue', fg='white').grid(row=0, column=0)
